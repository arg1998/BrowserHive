...
- Every minted secret is registered at birth: seed password, seed token, issued tokens, grants, cookies, `bw` session tokens, vault credentials during a fill, OTLP headers.
