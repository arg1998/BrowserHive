/** @module features/system/api — system queries: status (`GET /system`, patched by the `system` topic), config with provenance, realtime connections, degradations history, health (a degraded 503 still yields its body) (spec 04 §12.10, spec 03 §4.7) */
